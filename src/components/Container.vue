  ...
  <div class="m-4">
    <b-jumbotron bg-variant="dark" text-variant="white" border-variant="dark">
      ...
      <div class="mb-3">
        ...
        <input v-model="newList" type="text" class="
            form-control
            mb-1
            fw-bold
            bg-secondary
            ...
            text-white
            bg-opacity-25
          " id="exampleFormControlInput1" placeholder="example : 1,2,3,4,5,6" />
        <p class="fw-light">
      ...
      <div class="mb-3">
        ...
        <input v-model="value" type="text" class="
            form-control
            mb-1
            fw-bold
            bg-secondary
            ...
            text-white
            bg-opacity-25
          " id="exampleFormControlInput1" placeholder="example : 13" />
      </div>
      <modal :counter="counter" :value="value" :pos="pos"></modal>
      <b-button id="show-btn" @click="createList()" style="padding: 11px 0" class="w-100 fw-bold mt-3">Start
        Searching...</b-button>
    </b-jumbotron>
  </div>
</template>
